...
class MockEntitySanitizersTest extends PHPUnit_Framework_TestCase
{
  ...
  public function testStrtotimeParsesIso8601DateStrings()
  {
	$iso8601 = '2011-01-26T18:35:00.000Z';
	$expected = 1296066900;

	$this->assertSame($expected, Entity::strtotimeSanitize($iso8601));
  }

  public function testStrtotimeLeavesUnixTimestampsAlone()
  {
	$expected = 1296066900;
	$this->assertSame($expected, Entity::strtotimeSanitize($expected));
	$this->assertSame($expected, Entity::strtotimeSanitize((string)$expected));
  }

  public function testStrtotimeParseFailureReturnsFalse()
  {
	$this->assertSame(false, Entity::strtotimeSanitize('foo'));
  }
}
